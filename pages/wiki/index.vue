  ...
  <div class="uk-container uk-margin">
    <div class="hero">
      <form v-if="!confirming" class="purchase-form uk-animation-fade">
        <!-- <span class="form-title">HcRaid Network</span>
        <span class="form-subtitle"></span> -->
        <iframe
          src="https://wiki.hcraid.net"
          width="auto;"
          height="500"
        ></iframe>
          ...
          <div class="uk-width-1-2@m">
            <div class="transaction-details">
              ...
              <span class="tx-amount"
                >{{ youSendAmount }} {{ currencyTag }}</span
              >
        ...
        <!-- <div class="transaction-details">
          ...
          <span class="exchange-rate"
            >1 {{ currencyTag }} = {{ currencyRate }} USD</span
          >
        </div> -->
      ...
      <!-- <div class="hero-text">
        ...
        <span class="hero-paragraph"
          >Fast and secure way to purchase anything on our store using
          {{ getSupportedCurrenciesNum }} popular cryptocurrencies. Fully
          automated with no verification required.</span>
...
export default {
  ...
  methods: {
    ...
    startPurchase() {
      ...
      if (isNaN(this.youSendAmount) || this.youSendAmount <= 0.0) {
    ...
    async updateSendAmount() {
      return await this.updateExchangeRate().then(() => {
        this.youReceiveAmount =
          Math.round(
            (this.youSendAmount / this.currencyRate + Number.EPSILON) * 100
          ) / 100;
      });
    },
    ...
    async updateExchangeRate() {
      ...
      return await this.$axios
        .get("/store/exchange-rate?currency=" + this.currencyTag)
        .then((response) => {
          if (response.status === 200) {
