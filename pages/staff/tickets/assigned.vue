<template>
	<div class="uk-container uk-margin">
		<ul class="uk-breadcrumb">
			...
			<li>
				<nuxt-link :to="{ name: 'staff-tickets-assigned' }">Assigned Tickets</nuxt-link>
			</li>
		</ul>

		<div class="page-section uk-margin">
			<span class="page-title">Assigned Tickets</span>
...
<script>
    export default {
	    ...
	    async asyncData({$axios}) {
	        return await $axios.get('/staff/tickets/assigned').then(response => {
	            let data = {};
